...
public class ArticlesStatistics
{
    ...
    public static void main(String args[]) throws Exception
    {
        ...
        while(execute && c < 10)
        {
            ...
            {
                execute = true;
                as.writeToLog("WARNING: Try to read: " + c++ + ". " + e.toString());
                System.out.println("WARNING: Try to read: " + c + ". " + e.toString());
                Thread.sleep(10000);
            }
        }
        if(execute) as.writeToLog("ERROR: Failed to read new titles.");

        //UniversalDetector.main(new String[]{"C:\\Users\\User\\IdeaProjects\\Test\\" + dataBasePath});
    }

    String getNewTitles() throws UnsupportedEncodingException
    {
        Document doc;
        try
        {
